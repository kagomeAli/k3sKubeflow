...
def createLabel2Img(labelList, labDir, imageList, imgDir):
    ...
    # print(img_data)
    # print(label_data)
    print('step2: maker image successful')
    return [img_data, label_data]

def LabelAImg():
       # 解压路径，解压后路径
       zipPath = '/home/aoi1060/Downloads/fabricModel/labels/'
       # 图片列表
       ...
       zip_file_name = '/home/aoi1060/Downloads/labels-json.zip'
       # 解压文件至
       unzip_file(zip_file_name, zipPath)
       # 获取解压后的文件列表/labels/
